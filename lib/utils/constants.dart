...
//Color
const Color primaryColor = Color(0xffAE835B);
const Color secondaryColor = Color.fromARGB(255, 255, 49, 30);
...
//Speaker page
const String singer = 'assets/device_control/song_thumbnail.png';
//TV page
const String source = 'assets/icons_images/source.png';
//add_new_room
const String icon1 = 'assets/icons_images/icon1.png';
const String icon2 = 'assets/icons_images/icon2.png';
const String icon3 = 'assets/icons_images/icon3.png';
const String icon4 = 'assets/icons_images/icon4.png';
const String icon5 = 'assets/icons_images/icon5.png';
const String icon6 = 'assets/icons_images/icon6.png';
const String icon7 = 'assets/icons_images/icon7.png';
const String icon8 = 'assets/icons_images/icon8.png';
const String searchedDevice = 'assets/icons_images/searched_device.png';
